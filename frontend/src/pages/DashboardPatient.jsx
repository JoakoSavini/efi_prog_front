...
const DashboardPatient = () => {
  ...
  const loadMyAppointments = useCallback(async () => {
    ...
    try {
      ...
      const data = await appointmentsService.getByPatient(
      ...
      setStats({
        ...
        completedAppointments: data.filter((app) => app.status === "completed")
          .length,
        cancelledAppointments: data.filter((app) => app.status === "cancelled")
          .length,
      });
    } catch (error) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">Gestiona tus citas médicas</p>
      </div>
